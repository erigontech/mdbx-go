...
#cgo darwin LDFLAGS: ${SRCDIR}/dist/mdbx-static.o
...
#cgo windows CFLAGS: -pthread -W -Wall -Wno-format -Wno-implicit-fallthrough -Wno-cast-function-type -Wno-unused-parameter -Wno-format-extra-args -Wbad-function-cast -Wno-missing-field-initializers -O2 -g -Wno-deprecated-declarations
#cgo LDFLAGS: -v -L. -Wl,--allow-multiple-definition -L./dist -llibmdbx -LC:/WINDOWS/SYSTEM32/
//#cgo windows LDFLAGS: -v -Wl,--allow-multiple-definition -LC:/WINDOWS/SYSTEM32/ -lntdll -lmsvcrt

//#cgo LDFLAGS: -v -L. -L"${SRCDIR}"/../libmdbx/build -lmdbx

//#cgo LDFLAGS: -v -L. -L"${SRCDIR}"/../libmdbx/build -lmdbx
//#cgo LDFLAGS: -v -L. -LC:/WINDOWS/SYSTEM32/ -lntdll -L"${SRCDIR}"/../libmdbx/build -lmdbx-static
...
//#cgo linux LDFLAGS: mdbx-static.o
//#cgo windows LDFLAGS: -L ntdll_extra_target.vcxproj mdbx-static.vcxproj
