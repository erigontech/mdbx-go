...
#cgo CFLAGS: -pthread -W -Wall -Wl,-allow-multiple-definition -Wno-format -Wno-implicit-fallthrough -Wno-cast-function-type -Wno-unused-parameter -Wno-format-extra-args -Wbad-function-cast -Wno-missing-field-initializers -O2 -g -Wno-deprecated-declarations
#cgo windows LDFLAGS: -v -LC:/WINDOWS/SYSTEM32/ -lntdll
